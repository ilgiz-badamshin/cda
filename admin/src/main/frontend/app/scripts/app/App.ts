...
module cda.app {
  angular.module('adminApp', ['adminSecurity', 'ngCookies', 'ngResource', 'ngSanitize', 'ngLocale', 'ngRoute', 'restangular', 'ui.bootstrap', 'ui.grid', 'ui.grid.pagination', 'ui.grid.autoResize', 'ui.grid.resizeColumns', 'frapontillo.bootstrap-duallistbox', 'angular-img-cropper'])
