...
public class AXLAPIService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/ilgiz/java/cda/axl/src/main/resources/AXLAPI.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AXLAPIService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/ilgiz/java/cda/axl/src/main/resources/AXLAPI.wsdl");
        }
        WSDL_LOCATION = url;
    }
