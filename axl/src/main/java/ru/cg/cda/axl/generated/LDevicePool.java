...
public class LDevicePool {
    ...
    protected List<LDevicePool.LocalRouteGroup> localRouteGroup;
     ...
     * {@link LDevicePool.LocalRouteGroup }
     * 
     * 
     */
    public List<LDevicePool.LocalRouteGroup> getLocalRouteGroup() {
        if (localRouteGroup == null) {
            localRouteGroup = new ArrayList<LDevicePool.LocalRouteGroup>();
        }
