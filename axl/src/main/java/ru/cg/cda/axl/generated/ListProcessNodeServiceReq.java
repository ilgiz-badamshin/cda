...
/**
 * <p>Java class for ListProcessNodeServiceReq complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListProcessNodeServiceReq">
 *   &lt;complexContent>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="returnedTags" type="{http://www.cisco.com/AXL/API/10.0}LProcessNodeService"/>
...
@XmlType(name = "ListProcessNodeServiceReq", propOrder = {
    "searchCriteria",
    "returnedTags",
    "skip",
    "first"
})
public class ListProcessNodeServiceReq {

    @XmlElement(required = true)
    protected ListProcessNodeServiceReq.SearchCriteria searchCriteria;
    @XmlElement(required = true)
    protected LProcessNodeService returnedTags;
     ...
     * @return
     *     possible object is
     *     {@link ListProcessNodeServiceReq.SearchCriteria }
     *     
     */
    public ListProcessNodeServiceReq.SearchCriteria getSearchCriteria() {
     ...
     *     
     */
    public void setSearchCriteria(ListProcessNodeServiceReq.SearchCriteria value) {
     ...
     *     
     */
    public LProcessNodeService getReturnedTags() {
        return returnedTags;
    }
     ...
     *     
     */
    public void setReturnedTags(LProcessNodeService value) {
