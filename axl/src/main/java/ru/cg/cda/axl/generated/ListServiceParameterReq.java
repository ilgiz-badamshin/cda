...
/**
 * <p>Java class for ListServiceParameterReq complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListServiceParameterReq">
 *   &lt;complexContent>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="returnedTags" type="{http://www.cisco.com/AXL/API/10.0}LServiceParameter"/>
...
@XmlType(name = "ListServiceParameterReq", propOrder = {
    "searchCriteria",
    "returnedTags",
    "skip",
    "first"
})
public class ListServiceParameterReq {

    @XmlElement(required = true)
    protected ListServiceParameterReq.SearchCriteria searchCriteria;
    @XmlElement(required = true)
    protected LServiceParameter returnedTags;
     ...
     * @return
     *     possible object is
     *     {@link ListServiceParameterReq.SearchCriteria }
     *     
     */
    public ListServiceParameterReq.SearchCriteria getSearchCriteria() {
     ...
     *     
     */
    public void setSearchCriteria(ListServiceParameterReq.SearchCriteria value) {
     ...
     *     
     */
    public LServiceParameter getReturnedTags() {
        return returnedTags;
    }
     ...
     *     
     */
    public void setReturnedTags(LServiceParameter value) {
