 ...
 *       &lt;sequence>
 *         &lt;element name="newName" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="failedLogon" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="resetFailedLogonAttempts" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="lockoutDuration" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="credChangeDuration" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="credExpiresAfter" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="minCredLength" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="prevCredStoredNum" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="inactiveDaysAllowed" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="expiryWarningDays" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="trivialCredCheck" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
