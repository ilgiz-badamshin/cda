 ...
 *       &lt;sequence>
 *         &lt;element name="newName" type="{http://www.cisco.com/AXL/API/10.0}UniqueString50" minOccurs="0"/>
    ...
    extends NameAndGUIDRequest
{
    ...
    protected List<UpdateDevicePoolReq.LocalRouteGroup> localRouteGroup;
     ...
     * {@link UpdateDevicePoolReq.LocalRouteGroup }
     * 
     * 
     */
    public List<UpdateDevicePoolReq.LocalRouteGroup> getLocalRouteGroup() {
        if (localRouteGroup == null) {
            localRouteGroup = new ArrayList<UpdateDevicePoolReq.LocalRouteGroup>();
        }
