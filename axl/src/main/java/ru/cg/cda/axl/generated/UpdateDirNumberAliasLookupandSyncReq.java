...
/**
 * <p>Java class for UpdateDirNumberAliasLookupandSyncReq complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UpdateDirNumberAliasLookupandSyncReq">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.cisco.com/AXL/API/10.0}NameAndGUIDRequest">
 *       &lt;sequence>
 *         &lt;element name="ldapConfigName" type="{http://www.cisco.com/AXL/API/10.0}String50" minOccurs="0"/>
 *         &lt;element name="ldapManagerDisgName" type="{http://www.cisco.com/AXL/API/10.0}String128" minOccurs="0"/>
 *         &lt;element name="ldapPassword" type="{http://www.cisco.com/AXL/API/10.0}String128" minOccurs="0"/>
 *         &lt;element name="ldapUserSearch" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="ldapDirectoryServerUsage" type="{http://www.cisco.com/AXL/API/10.0}XLDAPDirectoryFunction" minOccurs="0"/>
 *         &lt;element name="keepAliveSearch" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="keepAliveTime" type="{http://www.cisco.com/AXL/API/10.0}XKeepAliveTimeInterval" minOccurs="0"/>
 *         &lt;element name="enableCachingofRecords" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 ...
 *                             &lt;element name="ldapPort" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="cacheSizeforAliasLookup" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="cacheAgeforAliasLookup" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "UpdateDirNumberAliasLookupandSyncReq", propOrder = {
    "ldapConfigName",
    "ldapManagerDisgName",
    "ldapPassword",
    "ldapUserSearch",
...
public class UpdateDirNumberAliasLookupandSyncReq
    extends NameAndGUIDRequest
{
    ...
    protected UpdateDirNumberAliasLookupandSyncReq.Servers servers;
     ...
     * @return
     *     possible object is
     *     {@link UpdateDirNumberAliasLookupandSyncReq.Servers }
     *     
     */
    public UpdateDirNumberAliasLookupandSyncReq.Servers getServers() {
        return servers;
    }
     ...
     *     
     */
    public void setServers(UpdateDirNumberAliasLookupandSyncReq.Servers value) {
        this.servers = value;
    }
    ...
    public static class Servers {
        ...
        protected List<UpdateDirNumberAliasLookupandSyncReq.Servers.Server> server;
         ...
         * {@link UpdateDirNumberAliasLookupandSyncReq.Servers.Server }
         * 
         * 
         */
        public List<UpdateDirNumberAliasLookupandSyncReq.Servers.Server> getServer() {
            if (server == null) {
                server = new ArrayList<UpdateDirNumberAliasLookupandSyncReq.Servers.Server>();
            }
            return this.server;
        }
