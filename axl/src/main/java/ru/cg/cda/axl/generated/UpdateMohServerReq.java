...
/**
 * <p>Java class for UpdateMohServerReq complex type.
 * 
 ...
 *         &lt;element name="maxUnicastConnections" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="maxMulticastConnections" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="fixedAudioSourceDevice" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="runFlag" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *         &lt;element name="useTrustedRelayPoint" type="{http://www.cisco.com/AXL/API/10.0}XStatus" minOccurs="0"/>
 *         &lt;element name="isMultiCastEnabled" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *         &lt;element name="baseMulticastIpaddress" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="baseMulticastPort" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="multicastIncrementOnIp" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence minOccurs="0">
 *                             &lt;element name="sourceId" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *                             &lt;element name="maxHops" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *                           &lt;/sequence>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
...
@XmlType(name = "UpdateMohServerReq", propOrder = {
    "newName",
    "description",
    "devicePoolName",
    "locationName",
    ...
    extends NameAndGUIDRequest
{
    ...
    protected UpdateMohServerReq.AudioSources audioSources;
     ...
     * @return
     *     possible object is
     *     {@link UpdateMohServerReq.AudioSources }
     *     
     */
    public UpdateMohServerReq.AudioSources getAudioSources() {
        return audioSources;
    }
     ...
     *     
     */
    public void setAudioSources(UpdateMohServerReq.AudioSources value) {
    ...
    public static class AudioSources {
        ...
        protected List<UpdateMohServerReq.AudioSources.AudioSource> audioSource;
         ...
         * {@link UpdateMohServerReq.AudioSources.AudioSource }
         * 
         * 
         */
        public List<UpdateMohServerReq.AudioSources.AudioSource> getAudioSource() {
            if (audioSource == null) {
                audioSource = new ArrayList<UpdateMohServerReq.AudioSources.AudioSource>();
            }
