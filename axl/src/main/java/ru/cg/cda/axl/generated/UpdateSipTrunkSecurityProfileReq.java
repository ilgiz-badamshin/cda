...
/**
 * <p>Java class for UpdateSipTrunkSecurityProfileReq complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="newName" type="{http://www.cisco.com/AXL/API/10.0}String64" minOccurs="0"/>
 *         &lt;element name="description" type="{http://www.cisco.com/AXL/API/10.0}String100" minOccurs="0"/>
 *         &lt;element name="securityMode" type="{http://www.cisco.com/AXL/API/10.0}XDeviceSecurityMode" minOccurs="0"/>
 *         &lt;element name="incomingTransport" type="{http://www.cisco.com/AXL/API/10.0}XTransport" minOccurs="0"/>
 *         &lt;element name="outgoingTransport" type="{http://www.cisco.com/AXL/API/10.0}XTransport" minOccurs="0"/>
 *         &lt;element name="digestAuthentication" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *         &lt;element name="noncePolicyTime" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="x509SubjectName" type="{http://www.cisco.com/AXL/API/10.0}String4096" minOccurs="0"/>
 *         &lt;element name="incomingPort" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="applLevelAuthentication" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 ...
 *         &lt;element name="transmitSecurityStatus" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *         &lt;element name="sipV150OutboundSdpOfferFiltering" type="{http://www.cisco.com/AXL/API/10.0}XV150SDPFilter" minOccurs="0"/>
 *         &lt;element name="allowChargingHeader" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "UpdateSipTrunkSecurityProfileReq", propOrder = {
    "newName",
    "description",
    "securityMode",
    "incomingTransport",
...
public class UpdateSipTrunkSecurityProfileReq
    extends NameAndGUIDRequest
{
    ...
    @XmlElement(defaultValue = "Use Default Filter")
    protected String sipV150OutboundSdpOfferFiltering;
    @XmlElement(defaultValue = "false")
    protected String allowChargingHeader;
    ...
    /**
     * Gets the value of the sipV150OutboundSdpOfferFiltering property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSipV150OutboundSdpOfferFiltering() {
        return sipV150OutboundSdpOfferFiltering;
    }

    /**
     * Sets the value of the sipV150OutboundSdpOfferFiltering property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSipV150OutboundSdpOfferFiltering(String value) {
        this.sipV150OutboundSdpOfferFiltering = value;
    }

    /**
     * Gets the value of the allowChargingHeader property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getAllowChargingHeader() {
        return allowChargingHeader;
    }

    /**
     * Sets the value of the allowChargingHeader property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAllowChargingHeader(String value) {
        this.allowChargingHeader = value;
    }
