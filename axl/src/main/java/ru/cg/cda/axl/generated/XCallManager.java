 ...
 *         &lt;element name="description" type="{http://www.cisco.com/AXL/API/10.0}String50" minOccurs="0"/>
 *         &lt;element name="autoRegistration" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence minOccurs="0">
 *                   &lt;element name="startDn" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *                   &lt;element name="endDn" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *                   &lt;element name="nextDn" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *                   &lt;element name="routePartitionName" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *                   &lt;element name="e164Mask" type="{http://www.cisco.com/AXL/API/10.0}String50" minOccurs="0"/>
 *                   &lt;element name="autoRegistrationEnabled" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *                   &lt;element name="universalDeviceTemplate" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *                   &lt;element name="lineTemplate" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence minOccurs="0">
 *                   &lt;element name="ethernetPhonePort" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *                   &lt;element name="mgcpPorts">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence minOccurs="0">
 *                             &lt;element name="listen" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *                             &lt;element name="keepAlive" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *                           &lt;/sequence>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence minOccurs="0">
 *                             &lt;element name="sipPhonePort" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *                             &lt;element name="sipPhoneSecurePort" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *                           &lt;/sequence>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="processNodeName" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="lbmGroup" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *       &lt;/sequence>
...
public class XCallManager {
    ...
    @XmlElementRef(name = "lbmGroup", type = JAXBElement.class)
    protected JAXBElement<XFkType> lbmGroup;
     ...
     *     
     */
    public JAXBElement<XFkType> getLbmGroup() {
        return lbmGroup;
    }
     ...
     *     
     */
    public void setLbmGroup(JAXBElement<XFkType> value) {
        this.lbmGroup = ((JAXBElement<XFkType> ) value);
    }
