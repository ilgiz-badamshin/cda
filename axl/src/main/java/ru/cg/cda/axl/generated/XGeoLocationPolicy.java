...
/**
 * <p>Java class for XGeoLocationPolicy complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="XGeoLocationPolicy">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence minOccurs="0">
 *         &lt;element name="name" type="{http://www.cisco.com/AXL/API/10.0}String50"/>
 *         &lt;element name="country" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="description" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="nationalSubDivision" type="{http://www.cisco.com/AXL/API/10.0}String100" minOccurs="0"/>
 *         &lt;element name="district" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="communityName" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="cityDivision" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="neighbourhood" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="street" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="leadingStreetDirection" type="{http://www.cisco.com/AXL/API/10.0}String50" minOccurs="0"/>
 *         &lt;element name="trailingStreetSuffix" type="{http://www.cisco.com/AXL/API/10.0}String50" minOccurs="0"/>
 *         &lt;element name="streetSuffix" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="houseNumber" type="{http://www.cisco.com/AXL/API/10.0}String16" minOccurs="0"/>
 *         &lt;element name="houseNumberSuffix" type="{http://www.cisco.com/AXL/API/10.0}String100" minOccurs="0"/>
 *         &lt;element name="landmark" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="location" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="floor" type="{http://www.cisco.com/AXL/API/10.0}String16" minOccurs="0"/>
 *         &lt;element name="occupantName" type="{http://www.cisco.com/AXL/API/10.0}String255" minOccurs="0"/>
 *         &lt;element name="postalCode" type="{http://www.cisco.com/AXL/API/10.0}String100" minOccurs="0"/>
 *         &lt;element name="relatedPolicies" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{http://www.cisco.com/AXL/API/10.0}XCommonMembersExtension">
 *                 &lt;sequence minOccurs="0">
 *                   &lt;element name="relatedPolicy" type="{http://www.cisco.com/AXL/API/10.0}XPolicyRelationship" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/extension>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "XGeoLocationPolicy", propOrder = {
    "name",
    "country",
    "description",
    "nationalSubDivision",
...
public class XGeoLocationPolicy {
    ...
    protected XGeoLocationPolicy.RelatedPolicies relatedPolicies;
     ...
     * @return
     *     possible object is
     *     {@link XGeoLocationPolicy.RelatedPolicies }
     *     
     */
    public XGeoLocationPolicy.RelatedPolicies getRelatedPolicies() {
     ...
     *     
     */
    public void setRelatedPolicies(XGeoLocationPolicy.RelatedPolicies value) {
