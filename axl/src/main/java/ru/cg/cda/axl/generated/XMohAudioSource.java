 ...
 *         &lt;element name="multicast" type="{http://www.cisco.com/AXL/API/10.0}boolean"/>
 *         &lt;element name="mohFileStatus" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="initialAnnouncement" type="{http://www.cisco.com/AXL/API/10.0}XFkType"/>
 *         &lt;element name="periodicAnnouncement" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="periodicAnnouncementInterval" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *         &lt;element name="localeAnnouncement" type="{http://www.cisco.com/AXL/API/10.0}XUserLocale"/>
