 ...
 *         &lt;element name="answerTooSoonTimer" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *         &lt;element name="answerTooLateTimer" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *         &lt;element name="delayBeforeRingingCell" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *         &lt;element name="ownerUserId" type="{http://www.cisco.com/AXL/API/10.0}XFkType"/>
 *         &lt;element name="enableUnifiedMobility" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *         &lt;element name="remoteDestinationProfileName" type="{http://www.cisco.com/AXL/API/10.0}XFkType"/>
 ...
 *         &lt;element name="dualModeDeviceName" type="{http://www.cisco.com/AXL/API/10.0}XFkType"/>
