...
/**
 * <p>Java class for XUniversalDeviceTemplate complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="XUniversalDeviceTemplate">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence minOccurs="0">
 *         &lt;element name="name" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="deviceDescription" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="devicePool" type="{http://www.cisco.com/AXL/API/10.0}XFkType"/>
 *         &lt;element name="deviceSecurityProfile" type="{http://www.cisco.com/AXL/API/10.0}XFkType"/>
 *         &lt;element name="sipProfile" type="{http://www.cisco.com/AXL/API/10.0}XFkType"/>
 *         &lt;element name="phoneButtonTemplate" type="{http://www.cisco.com/AXL/API/10.0}XFkType"/>
 *         &lt;element name="sipDialRules" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="callingSearchSpace" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="callingPartyTransformationCSSForInboundCalls" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="callingPartyTransformationCSSForOutboundCalls" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="reroutingCallingSearchSpace" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="subscribeCallingSearchSpaceName" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="useDevicePoolCallingPartyTransformationCSSforInboundCalls" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *         &lt;element name="useDevicePoolCallingPartyTransformationCSSforOutboundCalls" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *         &lt;element name="commonPhoneProfile" type="{http://www.cisco.com/AXL/API/10.0}XFkType"/>
 *         &lt;element name="commonDeviceConfiguration" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="softkeyTemplate" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="featureControlPolicy" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="phonePersonalization" type="{http://www.cisco.com/AXL/API/10.0}XPhonePersonalization"/>
 *         &lt;element name="mtpPreferredOriginatingCodec" type="{http://www.cisco.com/AXL/API/10.0}XSIPCodec"/>
 *         &lt;element name="outboundCallRollover" type="{http://www.cisco.com/AXL/API/10.0}XOutboundCallRollover"/>
 *         &lt;element name="mediaTerminationPointRequired" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *         &lt;element name="unattendedPort" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *         &lt;element name="requiredDtmfReception" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 ...
 *         &lt;element name="protectedDevice" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 ...
 *         &lt;element name="servicesProvisioning" type="{http://www.cisco.com/AXL/API/10.0}XPhoneServiceDisplay"/>
 ...
 *         &lt;element name="mlppDomain" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="mlppIndication" type="{http://www.cisco.com/AXL/API/10.0}XStatus"/>
 *         &lt;element name="mlppPreemption" type="{http://www.cisco.com/AXL/API/10.0}XPreemption"/>
 *         &lt;element name="doNotDisturb" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *         &lt;element name="dndOption" type="{http://www.cisco.com/AXL/API/10.0}XDNDOption"/>
 *         &lt;element name="dndIncomingCallAlert" type="{http://www.cisco.com/AXL/API/10.0}XRingSetting" minOccurs="0"/>
 *         &lt;element name="aarGroup" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="aarCallingSearchSpace" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="blfPresenceGroup" type="{http://www.cisco.com/AXL/API/10.0}XFkType"/>
 *         &lt;element name="blfAudibleAlertSettingPhoneBusy" type="{http://www.cisco.com/AXL/API/10.0}XStatus"/>
 *         &lt;element name="blfAudibleAlertSettingPhoneIdle" type="{http://www.cisco.com/AXL/API/10.0}XStatus"/>
 *         &lt;element name="userHoldMohAudioSource" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="networkHoldMohAudioSource" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 *         &lt;element name="location" type="{http://www.cisco.com/AXL/API/10.0}XFkType"/>
 *         &lt;element name="geoLocation" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="deviceMobilityMode" type="{http://www.cisco.com/AXL/API/10.0}XStatus"/>
 *         &lt;element name="mediaResourceGroupList" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 ...
 *         &lt;element name="ownerUserId" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="mobilityUserId" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="joinAcrossLines" type="{http://www.cisco.com/AXL/API/10.0}XStatus"/>
 *         &lt;element name="alwaysUsePrimeLine" type="{http://www.cisco.com/AXL/API/10.0}XStatus"/>
 *         &lt;element name="alwaysUsePrimeLineForVoiceMessage" type="{http://www.cisco.com/AXL/API/10.0}XStatus"/>
 *         &lt;element name="singleButtonBarge" type="{http://www.cisco.com/AXL/API/10.0}XBarge"/>
 *         &lt;element name="builtInBridge" type="{http://www.cisco.com/AXL/API/10.0}XStatus"/>
 *         &lt;element name="allowControlOfDeviceFromCti" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 ...
 *         &lt;element name="recordingOptions" type="{http://www.cisco.com/AXL/API/10.0}XRecordingFlag"/>
 *         &lt;element name="privacy" type="{http://www.cisco.com/AXL/API/10.0}XStatus"/>
 *         &lt;element name="loggedIntoHuntGroup" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 ...
 *         &lt;element name="idleTimer" type="{http://www.cisco.com/AXL/API/10.0}XInteger" minOccurs="0"/>
 ...
 *         &lt;element name="audibleMsgWaitingicatorPolicy" type="{http://www.cisco.com/AXL/API/10.0}XStatus"/>
 *         &lt;element name="logMissedCalls" type="{http://www.cisco.com/AXL/API/10.0}boolean" minOccurs="0"/>
 *         &lt;element name="visualMsgWaitingIndicatorPolicy" type="{http://www.cisco.com/AXL/API/10.0}XMWLPolicy"/>
 ...
 *         &lt;element name="MaxNumberOfCalls" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *         &lt;element name="ringSettingWhenPhoneIdle" type="{http://www.cisco.com/AXL/API/10.0}XRingSetting"/>
 *         &lt;element name="busyTrigger" type="{http://www.cisco.com/AXL/API/10.0}XInteger"/>
 *         &lt;element name="ringSettingWhenPhoneInUse" type="{http://www.cisco.com/AXL/API/10.0}XRingSetting" minOccurs="0"/>
 *         &lt;element name="directoryNumber" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="recordingProfile" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
 *         &lt;element name="callPickupGroupAudioAlertSettingPhoneActive" type="{http://www.cisco.com/AXL/API/10.0}XRingSetting" minOccurs="0"/>
 *         &lt;element name="callPickupGroupAudioAlertSettingPhoneIdle" type="{http://www.cisco.com/AXL/API/10.0}XRingSetting" minOccurs="0"/>
 *         &lt;element name="monitoringCallingSearchSpace" type="{http://www.cisco.com/AXL/API/10.0}XFkType" minOccurs="0"/>
...
@XmlType(name = "XUniversalDeviceTemplate", propOrder = {
    "name",
    "deviceDescription",
    "devicePool",
...
public class XUniversalDeviceTemplate {
    ...
    protected XUniversalDeviceTemplate.Speeddials speeddials;
    @XmlElement(defaultValue = "Default")
    ...
    protected XUniversalDeviceTemplate.ConfidentialAccess confidentialAccess;
    protected XUniversalDeviceTemplate.Services services;
     ...
     * @return
     *     possible object is
     *     {@link XUniversalDeviceTemplate.Speeddials }
     *     
     */
    public XUniversalDeviceTemplate.Speeddials getSpeeddials() {
        return speeddials;
    }
     ...
     *     
     */
    public void setSpeeddials(XUniversalDeviceTemplate.Speeddials value) {
     ...
     * @return
     *     possible object is
     *     {@link XUniversalDeviceTemplate.ConfidentialAccess }
     *     
     */
    public XUniversalDeviceTemplate.ConfidentialAccess getConfidentialAccess() {
     ...
     *     
     */
    public void setConfidentialAccess(XUniversalDeviceTemplate.ConfidentialAccess value) {
     ...
     * @return
     *     possible object is
     *     {@link XUniversalDeviceTemplate.Services }
     *     
     */
    public XUniversalDeviceTemplate.Services getServices() {
        return services;
    }
     ...
     *     
     */
    public void setServices(XUniversalDeviceTemplate.Services value) {
        this.services = value;
    }
