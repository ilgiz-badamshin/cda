 ...
 *         &lt;element name="productType" type="{http://www.cisco.com/AXL/API/10.0}XModel"/>
...
public class XUserPhoneAssociation {
    ...
    @XmlElementRef(name = "DirectoryNumberURIPartition", type = JAXBElement.class)
    protected JAXBElement<XFkType> directoryNumberURIPartition;
     ...
     *     
     */
    public JAXBElement<XFkType> getDirectoryNumberURIPartition() {
     ...
     *     
     */
    public void setDirectoryNumberURIPartition(JAXBElement<XFkType> value) {
        this.directoryNumberURIPartition = ((JAXBElement<XFkType> ) value);
    }
